...
<body id="page-top">
  ...
  <!-- ======= Intro Section ======= -->
  {{-- @if ($getHeader != null) --}}
  <div id="home" class="intro route bg-image" style="background-image: url('https://storage.googleapis.com/laravel-storage-portfolio/white-cloud-blue-sky-sea_74190-4488.jpg'">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">{{ $getHeader->down_text ?? '-' }}</span><strong class="text-slider"></strong></p>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                          @if ($getAbout != null)
                            <img src="https://storage.googleapis.com/laravel-storage-portfolio/WhatsApp%20Image%202022-05-31%20at%207.27.30%20PM.jpeg" style="height: 200px; object-fit: cover; object-position: center;" class="img-fluid rounded b-shadow-a" alt="">
                          @endif
                      </div>
                    </div>
                ...
                <div class="col-md-6">
                  <div class="about-me pt-4 pt-md-0">
                    ...
                    <p class="lead">
                      {{ $getAbout->description ?? 'This is about description' }}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6 mx-auto">
                    <div class="title-box-2 pt-4 pt-md-0">
                      <h5 class="title-left">
                        {{ $getFooter->description ?? 'Footer Title'  }}
                      </h5>
                    </div>
                    <div class="more-info">
                      <p class="lead">
                      ...
                      <ul class="list-ico">
                        <li><span class="ion-social-linkedin"></span> <a href="{{ $getFooter->address ?? '-'  }}" target="_blank">{{ $getAbout->name ?? '-' }}</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
